...
const ViewSongsPage = () => {
    return(
        <div className="top-dash-page w-[90%] grid grid-rows-[1fr_12fr]">
            <TableHeader />
            <SongsContainer />
        </div>
    )
...
const Song = ({ name, album, audioURL, songID }) => {
    return (
        <div className="grid grid-cols-4 h-[60px] w-[100%] text-[8pt] text-gray-400 border-b-[2px] border-gray-800">
